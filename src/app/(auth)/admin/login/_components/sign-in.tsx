...
// ✅ COMPLETO - Substitua seu arquivo existente
...
export default function SignIn() {
    ...
    const handleSuccess = async () => {
        ...
        // 🎯 LÓGICA DE REDIRECIONAMENTO ÚNICA
        if (isAdminRoute) {
            // Login pela rota secreta de admin
            ...
            // Login normal - redireciona baseado na role
            if (role === "admin" || role === "superadmin") {
                router.push("/admin/dashboard");
            } else {
        ...
        <Card className="w-full rounded-none max-h-[90vh] overflow-y-auto">
            <CardHeader>
                <CardTitle className="text-lg md:text-xl">
                    {isAdminRoute ? "Acesso Administrativo" : "Sign In"}
                </CardTitle>
            ...
            <CardContent>
                <div className="grid gap-4">
                    ...
                    {/* OAuth Buttons - Só aparece no login normal */}
                    {!isAdminRoute && (
                        <>
                  ...
                  <span className="bg-background px-2 text-muted-foreground">
                    ...
                    {/* Passkey Login - Só aparece no login normal */}
                    {!isAdminRoute && (
                        <Button
                            variant="outline"
